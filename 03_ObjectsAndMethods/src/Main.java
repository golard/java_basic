public class Main {
    ...
    public static void main(String[] args) {
        ...
        printer1.append("Третий текст документа, ", "Это третье имя текста, ");
        ...
        System.out.println("");
        printer1.print();
        printer1.append("Шестой текст документа, ", "Это шестрое имя текста, ");
        printer1.append("Седьмой текст документа, ", "Это седьмое имя текста, ");
        printer1.append("Восьмое текст документа, ", "Это восьмое имя текста, ");
        printer1.append("Десятое текст документа, ", "Это девятое имя текста, ");
        System.out.println("");
        printer1.print();
    }
}
